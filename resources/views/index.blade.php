...
<body>
                    ...
                    <nav class="main-nav">
                        ...
                        -->
                            ...
                            <li class="scroll-to-section" >
                                @auth
                                <a href="{{ url('/show_cart',Auth::user()->id) }}" style="color: orange"><i class="fa-solid fa-cart-shopping"></i>
                                Cart[{{ $count }}]</a>
                                @endauth
    ...
    @include('frontend.table_reservation');
                            ...
                            <div class="heading-tabs">
                                <div class="row">
                                    <div class="col-lg-6 offset-lg-3">
                                        <ul>
                                            <li><a href='#tabs-1'><img src="{{ asset('frontend/assets/images/tab-icon-01.png') }}"
                                                        alt="">Breakfast</a></li>
                                            <li><a href='#tabs-2'><img src="{{ asset('frontend/assets/images/tab-icon-02.png') }}"
                                                        alt="">Lunch</a></a></li>
                                            <li><a href='#tabs-3'><img src="{{ asset('frontend/assets/images/tab-icon-03.png') }}"
                                                        alt="">Dinner</a></a></li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-xs-12">
                    <div class="left-text-content">
                        <p>© Copyright Klassy Cafe Co.
                            ...
                            <br>Design & Developed by: Rabi Narayan </p>
                    </div>
                </div>
            </div>
        </div>
